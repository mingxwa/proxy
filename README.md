...
- **Value semantics**: While `proxy` is based on pointer semantics, we sometimes want an owning wrapper similar to [`std::any`](https://en.cppreference.com/w/cpp/utility/any) but open to abstractions. Please refer to [class template `box`](https://ngcpp.github.io/proxy/spec/box) for more details.
