...
static_assert(sizeof(pro::proxy<CopyableFacade>) == 4 * sizeof(void*)); // VTABLE should be embeded
...
static_assert(sizeof(pro::proxy<CopyableSmallFacade>) == 3 * sizeof(void*)); // VTABLE should be embeded
