...
// An incomplete type is enough to reason about the lifetime of a boxed value:
// every owning lifetime model is either bitwise trivially relocatable or has
// the same copy/move/destroy semantics as a `std::unique_ptr`.
struct incomplete;
