...
| [`add_view` ](basic_facade_builder/add_view.md)<br />*(since 3.2.0)*<br />*(deprecated since 3.2.1)* | Specifies the capability of implicit conversion to `proxy_view` to the template parameters |
