...
The alias template `as_view` modifies a specialization of [`basic_facade_builder`](../basic_facade_builder.md) to allow implicit conversion from [`proxy`](../proxy.md)`<F>` to [`proxy_view`](../proxy_view.md)`<F>`, where `F` is a built [facade](../facade.md) type.
